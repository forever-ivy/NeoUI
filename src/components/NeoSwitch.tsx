...
const switchVariants = cva(
  "inline-flex h-5.5 w-12 shrink-0 items-center justify-start rounded-full border-1 border-highlight bg-background p-0 shadow-inset transition-colors duration-250 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2 data-[checked]:bg-primary data-[checked]:border-primary",
);
